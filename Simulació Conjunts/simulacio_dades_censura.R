...
# SIMULACIÓ DELS COJUNTS DE DADES ON VARIEM LA CENSURA
...
dades1 <- coxed::sim.survdata(N = 1000, T = 500, type = "tvbeta",
                              ...
                              censor = 0.25, censor.cond = FALSE)


for (i in 1:100)  colnames(dades1[[i]]$data) <- c("X1", "X2", "X3", "X4", "X5","X6", "X7", "X8", "X9", "X10", "time", "status")
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e1_N1000_V10_C025.RData")
...
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e2_N1000_V10_C025.RData")
...
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e3_N1000_V10_C025.RData")
...
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e4_N1000_V10_C025.RData")
...
dades1 <- coxed::sim.survdata(N = 1000, T = 500, type = "tvbeta",
                              ...
                              hazard.fun = my.hazard,
                              mu = 0, sd = 0.5, covariate = 1, low = 0, high = 1, compare = median,
                              censor = 0.50, censor.cond = FALSE)


for (i in 1:100)  colnames(dades1[[i]]$data) <- c("X1", "X2", "X3", "X4", "X5","X6", "X7", "X8", "X9", "X10", "time", "status")
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e1_N1000_V10_C050.RData")
...
dades2 <- sim.survdata(N = 1000, T = 500, type = "tvbeta",
                       ...
                       hazard.fun = my.hazard,
                       mu = 0, sd = 0.5, covariate = 1, low = 0, high = 1, compare = median,
                       censor = 0.5, censor.cond = FALSE)


for (i in 1:100) colnames(dades2[[i]]$data) <- c("X1", "X2", "X3", "X4", "X5","X6", "X7", "X8", "X9", "X10", "time", "status")
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e2_N1000_V10_C050.RData")
...
for (i in 1:100)   colnames(dades3[[i]]$data) <- c("X1", "X2", "X3", "X4", "X5","X6", "X7", "X8", "X9", "X10", "time", "status")
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e3_N1000_V10_C050.RData")
...
for (i in 1:100) colnames(dades4[[i]]$data) <- c("X1", "X2", "X3", "X4", "X5","X6", "X7", "X8", "X9", "X10", "time", "status")
save.image("C:/Users/user/Desktop/TFM/Resultats simulació/Conjunts de dades/Censura/dades_e4_N1000_V10_C050.RData")
